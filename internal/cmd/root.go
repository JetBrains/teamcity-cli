...
import (
	...
	testcmd "github.com/JetBrains/teamcity-cli/internal/cmd/test"
...
Report issues:  https://jb.gg/tc/issues`,
	...
	addGrouped(cmd, "core", run.NewCmd(f), job.NewCmd(f), project.NewCmd(f), pipeline.NewCmd(f), testcmd.NewCmd(f))
