...
version: "0.1.0"
author: JetBrains
description: Migrating CI/CD pipelines to TeamCity. Use when user wants to migrate, convert, or switch from GitHub Actions. Other CI systems (GitLab, Jenkins, CircleCI, Azure DevOps, Travis, Bitbucket) will be added in follow-up releases.
---
